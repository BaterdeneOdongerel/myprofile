    ...
    <>
      ...
      <div className="timeline">
        ...
        <div className="timeline_unit left" style={{backgroundColor: "#ffe772"}}>
          ...
          <p>
            Redesign: a project to build new micro-service front-end react app from design scratch. <br/>
            * Played an important role in development of the app from requirement definition through deployment<br/>
            * Wrote the test code for the new modules.<br/>

            Rail Tracking: a system module for tracking the loads on the railroad.<br/>
            * Implemented and updated the software modules under direction of Sr. engineer<br/>
            * Improved the test coverage to 100%<br/>
        ...
        <div className="timeline_unit right" style={{backgroundColor: "#b4c8ff"}}>
          ...
          <div className="data_meta_hold">
            <h3 className="title_with_image">Started School at Maharishi Univeristy of Management</h3>
        ...
        <div className="timeline_unit left"  style={{backgroundColor: "rgb(221, 255, 217)"}}>
          ...
          <div className="data_meta_hold">
            <h3 className="title_with_image">Sofware Engineer at Unimedia Solution LLC</h3>
            <h4 className="subtitle_with_image">Aug 2015 - Jan 2018</h4>
          </div>


          <p>Crowd-job is a micro-task specific crowdsourcing service that enables individuals and businesses to coordinate the use of human intelligence to perform tasks that computers are currently unable to do.<br/>
            www.abstask.com , www.crowd-job.com<br/>

            Responsibilities:<br/>
            * Programmed module components using Ruby on Rails, Javascript, and Shell.<br/>
            * Automated unit and integrated testing and front-end testing using Capybara and Rspec scenarios.<br/>
            * Regular maintenance on modules and databases, like speeding up and keeping track of logs<br/>
            * Planning with the manager new features, future releases, and issues.<br/>
            * Improved integration testing company-wide by preparing Gitlab CI environment and documentation to support automated testing tools and processes<br/>
          </p>
        ...
        <div className="timeline_unit right"  style={{backgroundColor: "rgb(255, 214, 214)"}}>
          ...
          <p>Japanese-Mongolian jointly-owned telecommunications company. <br/>
            Developed and maintained web service collecting and storing employee information. <br/>

            Projects: <br/>
            • Info Survey: An internal web to take surveys from employees in Mobicom. Developed both back and front end <br/>
            • MRBT report service: a service to generate and render various reports from multimedia ring-back tone system which allows users to share their favorite songs with people who call them. <br/>
